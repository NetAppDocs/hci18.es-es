...
.Lo que necesitará
* Antes de iniciar este procedimiento, debes haberte puesto en contacto con el soporte de NetApp y haber recibido una pieza de reemplazo. El soporte estará involucrado durante la instalación de la pieza de reemplazo. Si aún no lo has hecho, contacta con https://www.netapp.com/company/contact-us/support/["Soporte técnico"^].
